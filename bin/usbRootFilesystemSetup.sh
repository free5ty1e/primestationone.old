...
echo Now we need to remove all partitions on the USB drive, keep pressing d then ENTER until no partitions remain... then press n p ENTER ENTER w ENTER to write changes...
sudo fdisk /dev/sda1
